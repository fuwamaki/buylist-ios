...
extension UIView {
    ...
    @discardableResult
    public func pinSubview(_ subview: UIView, margin: UIEdgeInsets = .zero, maximumSubViewWidth: CGFloat? = nil,
                              onLayoutMargin: LayoutMarginOptions = [], at atIndex: Int? = nil) ->
        (topConstraint: NSLayoutConstraint, leftConstraint: NSLayoutConstraint,
        bottomConstraint: NSLayoutConstraint, rightConstraint: NSLayoutConstraint) {
